<%@ Page language="c#" Inherits="Spire.WebDemo.CellSample" CodeFile="CellSample.aspx.cs" %>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			...
			<asp:button id="Button10" style="Z-INDEX: 130; LEFT: 400px; POSITION: absolute; TOP: 280px"
				runat="server" Width="96px" Text="Run" onclick="Button10_Click"></asp:button>
			...
			<asp:button id="Button8" style="Z-INDEX: 127; LEFT: 528px; POSITION: absolute; TOP: 224px" runat="server"
				Width="96px" Text="Chart2" onclick="Button8_Click"></asp:button><asp:button id="btnTextSample" style="Z-INDEX: 125; LEFT: 400px; POSITION: absolute; TOP: 520px"
				runat="server" Width="96px" Text="Run" onclick="btnTextSample_Click"></asp:button><asp:button id="btnHyberLinks" style="Z-INDEX: 124; LEFT: 400px; POSITION: absolute; TOP: 456px"
				runat="server" Width="96px" Text="Run" onclick="btnHyberLinks_Click"></asp:button><asp:button id="btnStream" style="Z-INDEX: 119; LEFT: 400px; POSITION: absolute; TOP: 400px"
				runat="server" Width="96px" Text="Run" onclick="btnStream_Click"></asp:button><asp:label id="Label16" style="Z-INDEX: 123; LEFT: 56px; POSITION: absolute; TOP: 520px" runat="server"
				...
				runat="server" Width="96px" Text="Run" onclick="btnImages_Click"></asp:button><asp:label id="Label9" style="Z-INDEX: 115; LEFT: 80px; POSITION: absolute; TOP: 376px" runat="server"
				...
				runat="server" Width="96px" Text="Chart1" onclick="btnCharts_Click"></asp:button><asp:label id="Label8" style="Z-INDEX: 112; LEFT: 56px; POSITION: absolute; TOP: 344px" runat="server"
				...
				Font-Bold="True" Height="24px" Width="208px" ForeColor="#C00000">01 - Multi-Sheets Sample</asp:label>
            <asp:image id="Image1" 
                style="Z-INDEX: 101; LEFT: 608px; POSITION: absolute; TOP: 16px" runat="server"
				Height="136px" Width="158px" 
                ImageUrl="http://www.e-iceblue.com/images/product_logo/spire.dataexport.png"></asp:image><asp:label id="Label1" style="Z-INDEX: 103; LEFT: 56px; POSITION: absolute; TOP: 160px" runat="server"
				...
				runat="server" Width="96px" Text="Run" onclick="btnMultiSheet_Click"></asp:button><asp:label id="Label4" style="Z-INDEX: 107; LEFT: 48px; POSITION: absolute; TOP: 80px" runat="server"
			...
			<asp:Button id="btnReturn" style="Z-INDEX: 126; LEFT: 672px; POSITION: absolute; TOP: 520px"
				runat="server" Width="96px" Text="Return" onclick="btnReturn_Click"></asp:Button>
		</form>
	</body>
</HTML>
