	...
	<body>
		<form id="Form1" method="post" runat="server">
			...
			<asp:button id="Button8" style="Z-INDEX: 127; LEFT: 528px; POSITION: absolute; TOP: 224px" runat="server"
				...
				Height="136px" Width="158px" ImageUrl="http://www.e-iceblue.com/images/product_logo/spire.dataexport.png"></asp:image><asp:label id="Label1" style="Z-INDEX: 103; LEFT: 56px; POSITION: absolute; TOP: 160px" runat="server"
